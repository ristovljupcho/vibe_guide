 ...
 *
 * <ul>
 *   <li>Retrieving a list of all favourite places for a user
 *   <li>Toggling a place as favourite (add/remove)
 * </ul>
 *
 * <p>Implementations must ensure user and place existence validation.
 */
public interface FavouritePlaceService {
   ...
   *
   * <ul>
   *   <li>If the place is already in the user's favourites ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ it is removed.
