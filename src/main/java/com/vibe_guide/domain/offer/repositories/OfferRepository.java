package com.vibe_guide.domain.offer.repositories;
...
public interface OfferRepository extends JpaRepository<Offer, UUID> {
  ...
  @EntityGraph(attributePaths = "place")
  @Query("SELECT o FROM Offer o " + "WHERE o.startDate <= :now " + "AND o.endDate >= :now")
  ...
  @EntityGraph(attributePaths = "place")
  @Query("SELECT o " + "FROM Offer AS o " + "WHERE o.startDate > :today")
