package com.vibe_guide.workinghours.controllers;
...
import com.vibe_guide.workinghours.services.WorkingHoursManagementService;
...
public class WorkingHoursController {
    ...
    public ResponseEntity<String> deleteWorkingHoursForPlace(@PathVariable UUID placeId,
                                                             @RequestBody @Validated
