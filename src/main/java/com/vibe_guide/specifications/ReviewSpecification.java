...
public class ReviewSpecification {
   ...
   *
   * <p>If the provided userId is null, this specification returns a conjunction, meaning no
  ...
  /**
   * If the provided rating is null, this specification returns a conjunction, meaning no filtering
   * is applied.
   *
   * @param rating the minimum rating threshold to filter by; if null, no filtering is applied.
   * @return a Specification for filtering reviews with a rating greater than or equal to the
   *     specified value.
   */
