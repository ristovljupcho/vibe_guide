...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ExceptionMessage> handleCustomBadRequestException(
    ...
    ExceptionMessage exceptionMessage =
        new ExceptionMessage(customBadRequestException.getMessage());
  ...
  public ResponseEntity<ExceptionMessage> handleCustomUnprocessableEntityException(
    ...
    ExceptionMessage exceptionMessage =
        new ExceptionMessage(customUnprocessableEntityException.getMessage());
    log.error(
        "Unprocessable entity exception: {}", customUnprocessableEntityException.getMessage());
